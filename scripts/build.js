...
async function registerCommands() {
    const availableCommands = [
        ...
        { command: "gif", description: "Sendet eine zufällige Animation. Optional mit schlagwort" },
        { command: "wuerfel", description: "Ein Würfel mit einer zufälligen Zahl zwischen 1 und 6" }
    ]
